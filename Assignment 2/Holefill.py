...
im = Image.open('assignment2data/donkey.jpg').convert('RGB')
...
if os.path.isfile('assignment2data/fill_region.pkl') and os.path.isfile('assignment2data/texture_region.pkl'):
	fill_region_file = open('assignment2data/fill_region.pkl', 'rb')
	fillRegion = pickle.load( fill_region_file )
	fill_region_file.close()

	texture_region_file = open('assignment2data/texture_region.pkl', 'rb')
